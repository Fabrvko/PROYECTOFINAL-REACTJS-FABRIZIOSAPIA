...
function Ticket({ticket}) {
    ...
    return (
        <div className='ticket'>
            <h2 className='titulo'>Órden de compra:</h2>
            <section className='nOrden'>
                <h2>Número de órden: {ticket.id}</h2>
            ...
            <section className='pedido'>
                <section className='buyer'>
                    ...
                    <p><span>Teléfono de contacto:</span> {ticket.buyer.telefono}</p>
                ...
                <h3 className='total'>Total: $<span>{ticket.total}</span></h3>
            </section>
            :null}
